...
#define framebuffer w4_memory.framebuffer
#define drawColors w4_memory.drawColors
...
static inline void drawPoint (uint8_t color, int x, int y) {
    int idx = (WIDTH * y + x) >> 2;
    int shift = (x & 0x3) << 1;
    int mask = 0x3 << shift;
...
static inline void drawPointUnclipped (uint8_t color, int x, int y) {
...
void w4_framebufferHLine (int x, int y, int len) {
    ...
    platform_draw_partial(x, y, len, 1);
}
...
void w4_framebufferVLine (int x, int y, int len) {
    ...
    platform_draw_partial(x, y, 1, len);
}
...
void w4_framebufferRect (int x, int y, int width, int height) {
    ...
    platform_draw_partial(x, y, width, height);
}
...
void w4_framebufferLine (int x1, int y1, int x2, int y2) {
    ...
    platform_draw_partial(ox1, oy1, x2-ox1+1, y2-oy1+1);
}
...
template<bool bpp2, bool flipX, bool flipY, bool rotate>
void w4_framebufferBlit_tpl (const uint8_t* sprite, int dstX, int dstY, int width, int height,
    int srcX, int srcY, int srcStride) {
    ...
    if (!flipX && !flipY && !rotate) {
        ...
        for (int y = clipYMin; y < clipYMax; y++) {
            for (int x = clipXMin; x < clipXMax; x++) {
                ...
                const int sx = srcX + ((flipX ^ rotate) ? width - x - 1 : x);
    ...
    platform_draw_partial(clipXMin, clipYMin, clipXMax-clipXMin, clipYMax-clipYMin);
}
...
void w4_framebufferBlit (const uint8_t* sprite, int dstX, int dstY, int width, int height,
    ...
    switch (((bpp2 > 0) << 3) | ((flipX > 0) << 2) | ((flipY > 0) << 1) | (rotate > 0)) {
    case 0: w4_framebufferBlit_tpl<false, false, false, false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 1: w4_framebufferBlit_tpl<false, false, false, true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 2: w4_framebufferBlit_tpl<false, false, true,  false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 3: w4_framebufferBlit_tpl<false, false, true,  true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 4: w4_framebufferBlit_tpl<false, true, false, false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 5: w4_framebufferBlit_tpl<false, true, false, true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 6: w4_framebufferBlit_tpl<false, true, true,  false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 7: w4_framebufferBlit_tpl<false, true, true,  true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 8: w4_framebufferBlit_tpl<true, false, false, false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 9: w4_framebufferBlit_tpl<true, false, false, true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 10: w4_framebufferBlit_tpl<true, false, true,  false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 11: w4_framebufferBlit_tpl<true, false, true,  true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 12: w4_framebufferBlit_tpl<true, true, false, false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 13: w4_framebufferBlit_tpl<true, true, false, true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 14: w4_framebufferBlit_tpl<true, true, true,  false>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    case 15: w4_framebufferBlit_tpl<true, true, true,  true>(sprite, dstX, dstY, width, height, srcX, srcY, srcStride); break;
    }
}
